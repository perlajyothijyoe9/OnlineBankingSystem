package com.jyothirlatha.bankmvc.feign;
...
public interface CustomerFeign {
	...
	public CustomerEntity getCustomerDetails(@RequestHeader("Authorization") String token,
			@PathVariable(name = "id") String id) throws CustomerNotFoundException;

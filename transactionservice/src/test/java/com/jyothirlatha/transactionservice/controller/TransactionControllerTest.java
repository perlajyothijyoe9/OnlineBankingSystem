package com.jyothirlatha.transactionservice.controller;
...
import com.jyothirlatha.transactionservice.exception.GlobalExceptionHandler;
...
import com.jyothirlatha.transactionservice.service.TransactionService;
...
public class TransactionControllerTest {
	...
	public void getAllTransactionById() throws Exception {
		...
		MvcResult andReturn = mockMvc.perform(get("/getAllTransByAccId/10054546").header("Authorization", token))
				.andExpect(status().isOk()).andReturn();
		String contentAsString = andReturn.getResponse().getContentAsString();
		// List<Transaction> res =
		// transRepo.findBySourceAccountIdOrderByInitiationDate(10054546);

package com.jyothirlatha.transactionservice.repository;
...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
	...
	// @Query("select t from Transaction where t.sourceAccountId =:id or
	// t.targetAccountId = :id order by t.initiationDate")

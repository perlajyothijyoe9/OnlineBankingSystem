...
public class TransactionServiceTest {
	...
	public void getConsumerBusinessTest1() throws Exception {
		// Optional<Consumer> consumer=Optional.of(new Consumer(10, "Akash Kumar Soni",
		// new Date(1997,07,01), "ABC123", "akashconsumer@mail.com", true,
		// "akash@mail.com", "New Business"));
		...
		// when(transactionRepository.findBySourceAccountIdOrderByInitiationDate(1)).thenReturn((List<Transaction>)
		// inp);
	...
	//
	// when(consumerRepository.findById(10)).thenThrow(new
	// ConsumerNotFoundException());
	// assertThrows( ConsumerNotFoundException.class,
	// ()->consumerService.getConsumerBusiness(10));
	// }
	//
	// @Test
	...
	// when(consumerRepository.findById(10)).thenReturn(consumer);
	// assertThrows(ConsumerNotFoundException.class,
	// ()->consumerService.getConsumer(10));
	// }
	//
	//
	// @Test
	// void getBusinessTest() {
	// Optional<Business> business=Optional.of(new Business(10, 10, "My Business",
	// "Owned", 1000, 900, 10));
	...
	// when(businessRepository.findById(10)).thenReturn(business);
	// assertThrows(BusinessNotFoundException.class,
	// ()->consumerService.getBusiness(10));
	// }
	//
	// @Test
	// void getPropertyTest() {
	// Optional<Property> property=Optional.of(new Property(10, 10, 10, 500,
	// "Building", 10, 5, 2350, 100));
	...
	// consumerService.getProperty(10));
	// }
	//
	// @Test
	// void saveConsumerBusinessTest1() {
	// Consumer consumer=new Consumer(10, "Akash Kumar Soni", new Date(1997,07,01),
	// "ABC123", "akashconsumer@mail.com", true, "akash@mail.com", "New Business");
	// Business business=new Business();
	// when(consumerRepository.findByEmail("akashconsumer@mail.com")).thenReturn(consumer);
	// assertThrows(ConsumerAlreadyExistException.class,
	// ()->consumerService.saveConsumerBusiness(consumer, business));
	// }
	//
	// @Test
	...
	// Consumer consumer=new Consumer(10, "Akash Kumar Soni", new Date(1997,07,01),
	// "ABC123", "akashconsumer@mail.com", true, "akash@mail.com", "New Business");
	// Business business=new Business(10, 10, "My Business", "Owned", 1000, 900,
	// 10);
	// when(consumerRepository.findById(10)).thenReturn(Optional.of(consumer));
	// when(businessRepository.findById(10)).thenReturn(Optional.of(new
	// Business()));
	// //assertThrows(ConsumerAlreadyExistException.class,
	// ()->consumerService.saveConsumerBusiness(consumer, business));
	// assertEquals("Consumer Business details updated
	// successfully",consumerService.updateConsumerBusiness(consumer, business));
	// }
	//
	// @Test
	...
	// assertEquals("Akash Kumar
	// Soni",consumerService.getConsumerBusiness("akashconsumer@mail.com").getConsumer().getName());
	// }
	//
	// @Test
	...
	// when(businessRepository.findByConsumerId(10)).thenReturn(business);
	// assertThrows(BusinessNotFoundException.class,
	// ()->consumerService.getConsumerBusiness("akashconsumer@mail.com"));
	// }
	//
	// @Test
	...
	// when(businessRepository.findByConsumerId(10)).thenReturn(null);
	// assertThrows(BusinessNotFoundException.class,
	// ()->consumerService.getBusinessByConsumerId(10));
	// }
	//
	// @Test
	...
	// consumerList.add(new Consumer(10, "Akash Kumar Soni", new Date(1997,07,01),
	// "ABC123", "akashconsumer@mail.com", true, "akash@mail.com", "New Business"));
	//
	...
	// Property property=new Property(10, 10, 10, 500, "Building", 10, 5, 2350,
	// 100);
	// when(consumerRepository.findById(10)).thenReturn(Optional.of(new
	// Consumer()));
	// when(propertyRepository.findByConsumerId(10)).thenReturn(property);
	// assertEquals("Building",
	// consumerService.getConsumerProperty(10).getPropertyType());
	// }
	//
	// @Test
	...
	// assertEquals("Property Details saved successfully",
	// consumerService.saveBusinessProperty(new Property()));
	// }
	//
	// @Test
	...
	// assertEquals("Property updated successfully",
	// consumerService.updateBusinessProperty(10, property));
	// }
	//
	// @Test
	...
	// 100);
	// when(propertyRepository.findById(10)).thenReturn(Optional.of(property));
	// assertEquals("You do not own this property",
	// consumerService.updateBusinessProperty(11, property));
	// }
	//
	// @Test
	...
	// when(propertyRepository.findById(10)).thenReturn(property);
	// assertThrows(PropertyNotFoundException.class,
	// ()->consumerService.updateBusinessProperty(10, new Property(10, 10, 10, 500,
	// "Building", 10, 5, 2350, 100)));
	// }
	//
	// @Test
	// void hasPermissionTest() {
	// when(authClient.getValidity("token")).thenReturn(new
	// ResponseEntity<AuthResponse>(new AuthResponse(true),HttpStatus.OK));
	...
	// when(authClient.getValidity("token")).thenReturn(new
	// ResponseEntity<AuthResponse>(new AuthResponse(false),HttpStatus.OK));
	// assertThrows(AccessDeniedException.class,
	// ()->consumerService.hasPermission("token"));
	// }
